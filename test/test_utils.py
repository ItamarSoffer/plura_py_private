...
class TestUtil(unittest.TestCase):
    ...
    def test_sanitize_filename_restricted(self):
        ...
        self.assertEqual(
            sanitize_filename("\u5927\u58f0\u5e26 - Song", restricted=True), "Song"
        )
        self.assertEqual(
            sanitize_filename("\u603b\u7edf: Speech", restricted=True), "Speech"
        )
    ...
    def test_expand_path(self):
        def env(var):
            return (
                "%{0}%".format(var) if sys.platform == "win32" else "${0}".format(var)
            )
    ...
    def test_ordered_set(self):
        self.assertEqual(
            orderedSet([1, 1, 2, 3, 4, 4, 5, 6, 7, 3, 5]), [1, 2, 3, 4, 5, 6, 7]
        )
    ...
    def test_unified_dates(self):
        ...
        self.assertEqual(
            unified_strdate("11/26/2014 11:30:00 AM PST", day_first=False), "20141126"
        )
        self.assertEqual(
    ...
    def test_unified_timestamps(self):
        ...
        self.assertEqual(
            unified_timestamp("11/26/2014 11:30:00 AM PST", day_first=False), 1417001400
        )
        self.assertEqual(
            unified_timestamp("2/2/2015 6:47:40 PM", day_first=False), 1422902860
        )
    ...
    def test_determine_ext(self):
        ...
        self.assertEqual(
            determine_ext("http://example.com/foo/bar.nonext/?download", None), None
        )
        self.assertEqual(
            determine_ext("http://example.com/foo/bar/mp4?download", None), None
        )
        self.assertEqual(
    ...
    def test_xpath_element(self):
        ...
        self.assertRaises(ExtractorError, xpath_element, doc, ["div/bar"], fatal=True)
        self.assertRaises(
            ExtractorError, xpath_element, doc, ["div/bar", "div/baz"], fatal=True
        )
    ...
    def test_urljoin(self):
        ...
        self.assertEqual(
            urljoin(b"http://foo.de/", b"/a/b/c.txt"), "http://foo.de/a/b/c.txt"
        )
        ...
        self.assertEqual(
            urljoin("http://foo.de/", "//foo.de/a/b/c.txt"), "//foo.de/a/b/c.txt"
        )
        self.assertEqual(
        ...
        self.assertEqual(
            urljoin(["foobar"], "http://foo.de/a/b/c.txt"), "http://foo.de/a/b/c.txt"
        )
        self.assertEqual(urljoin("http://foo.de/", None), None)
        self.assertEqual(urljoin("http://foo.de/", ""), None)
        self.assertEqual(urljoin("http://foo.de/", ["foobar"]), None)
        self.assertEqual(
            urljoin("http://foo.de/a/b/c.txt", ".././../d.txt"), "http://foo.de/d.txt"
        )
        self.assertEqual(
            urljoin("http://foo.de/a/b/c.txt", "rtmp://foo.de"), "rtmp://foo.de"
        )
    ...
    def test_fix_xml_ampersands(self):
        ...
        self.assertEqual(
            fix_xml_ampersands('"&amp;x=y&wrong;&z=a'), '"&amp;x=y&amp;wrong;&amp;z=a'
        )
        self.assertEqual(
            fix_xml_ampersands("&amp;&apos;&gt;&lt;&quot;"), "&amp;&apos;&gt;&lt;&quot;"
        )
    ...
    def test_update_url_query(self):
        ...
        self.assertEqual(
            query_dict(
                update_url_query("http://example.com/path", {"bitrate": 5020.43})
            ),
            query_dict("http://example.com/path?bitrate=5020.43"),
        )
        self.assertEqual(
            query_dict(
                update_url_query("http://example.com/path", {"test": "第二行тест"})
            ),
            query_dict(
    ...
    def test_multipart_encode(self):
        ...
        self.assertEqual(
            multipart_encode(
                {"欄位".encode("utf-8"): "值".encode("utf-8")}, boundary="AAAAAA"
            )[0],
    ...
    def test_dict_get(self):
        ...
        for key, false_value in FALSE_VALUES.items():
            ...
            self.assertEqual(
                dict_get(d, ("b", "c", key,), skip_false_values=False), false_value
            )
    ...
    def test_encode_compat_str(self):
        self.assertEqual(
            encode_compat_str(b"\xd1\x82\xd0\xb5\xd1\x81\xd1\x82", "utf-8"), "тест"
        )
    ...
    def test_parse_codecs(self):
        ...
        self.assertEqual(
            ...
            {"vcodec": "avc1.77.30", "acodec": "mp4a.40.2",},
        )
        self.assertEqual(
            parse_codecs("mp4a.40.2"), {"vcodec": "none", "acodec": "mp4a.40.2",}
        )
        self.assertEqual(
            parse_codecs("mp4a.40.5,avc1.42001e"),
            {"vcodec": "avc1.42001e", "acodec": "mp4a.40.5",},
        )
        self.assertEqual(
            parse_codecs("avc3.640028"), {"vcodec": "avc3.640028", "acodec": "none",}
        )
        self.assertEqual(
            parse_codecs(", h264,,newcodec,aac"), {"vcodec": "h264", "acodec": "aac",}
        )
        self.assertEqual(
        ...
        self.assertEqual(
            parse_codecs("theora, vorbis"), {"vcodec": "theora", "acodec": "vorbis",}
        )
        self.assertEqual(
            parse_codecs("unknownvcodec, unknownacodec"),
            {"vcodec": "unknownvcodec", "acodec": "unknownacodec",},
        )
    ...
    def test_escape_rfc3986(self):
        ...
        self.assertEqual(
            escape_rfc3986("%D1%82%D0%B5%D1%81%D1%82"), "%D1%82%D0%B5%D1%81%D1%82"
        )
    ...
    def test_escape_url(self):
        ...
        self.assertEqual(
            escape_url("http://vimeo.com/56015672#at=0"),
    ...
    def test_extract_attributes(self):
        ...
        self.assertEqual(
            extract_attributes('<e x="décompose&#769;">'), {"x": "décompose\u0301"}
        )
    ...
    def test_intlist_to_bytes(self):
        self.assertEqual(
            intlist_to_bytes([0, 1, 127, 128, 255]), b"\x00\x01\x7f\x80\xff"
        )
...
ffmpeg version 2.4.4 Copyright (c) 2000-2014 the FFmpeg ..."""
    ...
    def test_is_html(self):
        ...
        self.assertTrue(is_html(b"\xef\xbb\xbf<!DOCTYPE foo>\xaaa"))  # UTF-8 with BOM
        self.assertTrue(
            is_html(b"\xff\xfe<\x00h\x00t\x00m\x00l\x00>\x00\xe4\x00")  # UTF-16-LE
        )
        self.assertTrue(
            is_html(b"\xfe\xff\x00<\x00h\x00t\x00m\x00l\x00>\x00\xe4")  # UTF-16-BE
        )
        self.assertTrue(
            is_html(  # UTF-32-BE
...
"""
    ...
    def test_cli_option(self):
        ...
        self.assertEqual(
            cli_option({"retries": 10}, "--retries", "retries"), ["--retries", "10"]
        )
    ...
    def test_get_elements_by_attribute(self):
        ...
        self.assertEqual(
            get_elements_by_attribute("class", "foo bar", html), ["nice", "also nice"]
        )
